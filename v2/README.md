...
Вторая публичная реконструкция юридического AI-ассистента с Claude-provider. Репозиторий использует только
синтетические данные и не содержит документов, credential'ов или выгрузок исходного заказчика.
