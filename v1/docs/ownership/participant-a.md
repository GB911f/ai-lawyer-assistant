# v1 / Participant A — Research & Platform
...
Специфика v1: локальный streaming-provider `qwen3:14b` через Ollama, без внешнего LLM API.

## Порядок загрузки

Распакуйте архив v1/Participant A в корень общего репозитория. Все файлы уже находятся внутри
директории `v1/`. Затем добавьте архив v1/Participant B. Пути архивов не пересекаются.
